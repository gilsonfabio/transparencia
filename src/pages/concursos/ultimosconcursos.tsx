...
/*
Ultimosconcursos.getInitialProps = async () =>{
  const response = await axios.get(
    'https://webio.aparecida.go.gov.br/api/conc/publicacoes/ultimaspostagens'
  );

  return { concursos: response.data}
};
*/