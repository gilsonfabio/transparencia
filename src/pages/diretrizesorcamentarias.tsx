...
export default function DiretrizesOrcamentarias() {
  ...
  useEffect(() => {      
    ...
    axios({
        method: 'get',    
        url: `https://webio.aparecida.go.gov.br/api/tnsp/gestaoorcamentaria/anos/25`,
    }).then(function(resp) {
        console.log(resp)
        setYears(resp.data)
    }).catch(function(error) {
  ...
  const itemsSubmenu = [
    {
        menId: '1',
        menTitle: 'Lei de Diretrizes Orçamentaria',
        breadcrumbs:[
