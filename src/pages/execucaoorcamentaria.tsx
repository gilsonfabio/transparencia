...
export default function ExeOrcamentaria({categorias}: apiProps) {
    ...
    const itemsSubmenu = [
        {
            menId: '1',
            menTitle: 'Relatório de Execução Orçamentária',
            breadcrumbs:[
...
export const getServerSideProps: GetServerSideProps = async () => {
    let urlCategorias = "https://webio.aparecida.go.gov.br/api/tnsp/gestaoorcamentaria/navs/2";
