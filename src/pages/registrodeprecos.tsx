...
export default function RegistrodePrecos() {
    ...
    useEffect(() => {    
        ...
        axios({
            method: 'post',    
            url: `https://webio.aparecida.go.gov.br/api/lict/v1/filtrar/registropreco`,
                    ...
                    <div className='flex flex-row justify-between items-center w-full text-black p-2 bg-[#F3F3F3] dark:bg-gray-800'> 
                        ...
                        <div className='flex flex-col w-full h-full text-black'>
                            ...
                            {itens.map((item:any, idx) => {
                                return <Link key={idx} href={`/registrodeprecos/${item.id}`}>
                                ...
                                <div className="flex flex-row items-start justify-between px-2 py-0 ">
                                  <div className="flex flex-col items-start px-2 py-1">
                                    <span className='text-[12px] font-bold'>Assinatura</span>
                                ...
                                <div className="flex flex-row items-start justify-between px-2">
                                  <div className="flex flex-col items-start px-2 ">
                                    <span className='text-[12px] font-bold'>Fornecedor</span>
                                    <div className="text-[12px] mb-0">{item.fornecedor}</div>
                                  </div>                                  
                                </div>
                                <div className="flex flex-row items-start justify-between px-2">
                                  <div className="flex flex-col items-start px-2 py-1">
                                    <span className='text-[12px] font-bold'>Vlr Estimado</span>
