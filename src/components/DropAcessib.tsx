            ...
            <div className="flex items-center">              
              <div className="hidden md:block">
                <div className="ml-10 flex items-center space-x-4">
                    ...
                    <a href="/acessoinformacao" className="text-white hover:text-gray-400 px-1 py-2 text-sm font-medium"><FaInfoCircle className="w-4 h-4 fa-solid fa-circle-info"/></a>
